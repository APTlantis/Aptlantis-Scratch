...
- `theme.css`: theme variables and common SiYuan surface styling
- `icon.png`: marketplace icon generated from the Aptlantis Scratch logo
- `preview.png`: package preview image generated from the logo and palette

## Palette Anchor

- Background: `#111419`
- Raised surface: `#171B21`
- Primary control: `#496C7A`
- Orange accent: `#B56D35`
- Cyan accent: `#72A5B1`
- Selection: `rgba(73, 108, 122, 0.48)`
- Text: `#DCE1E3`
